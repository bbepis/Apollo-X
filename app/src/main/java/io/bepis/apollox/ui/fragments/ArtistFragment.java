...
import io.bepis.apollox.adapters.ArtistAdapter;
import io.bepis.apollox.loaders.ArtistLoader;
...
import io.bepis.apollox.model.Artist;
...
public class ArtistFragment extends Fragment implements LoaderCallbacks<List<Artist>>,
    ...
    private boolean isSimpleLayout() {
        return PreferenceUtils.getInstance(getActivity()).isSimpleLayout(PreferenceUtils.ARTIST_LAYOUT,
                getActivity());
    }

    private boolean isDetailedLayout() {
        return PreferenceUtils.getInstance(getActivity()).isDetailedLayout(PreferenceUtils.ARTIST_LAYOUT,
                getActivity());}
}
