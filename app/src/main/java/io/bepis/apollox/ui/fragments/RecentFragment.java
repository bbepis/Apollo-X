...
import io.bepis.apollox.MusicStateListener;
import io.bepis.apollox.R;
import io.bepis.apollox.adapters.AlbumAdapter;
import io.bepis.apollox.cache.ImageFetcher;
import io.bepis.apollox.loaders.RecentLoader;
...
public class RecentFragment extends Fragment implements LoaderCallbacks<List<Album>>,
    ...
    private boolean isSimpleLayout() {
        return PreferenceUtils.getInstance(getActivity()).isSimpleLayout(PreferenceUtils.RECENT_LAYOUT,
                getActivity());
    }

    private boolean isDetailedLayout() {
        return PreferenceUtils.getInstance(getActivity()).isDetailedLayout(PreferenceUtils.RECENT_LAYOUT,
                getActivity());
    }
}
