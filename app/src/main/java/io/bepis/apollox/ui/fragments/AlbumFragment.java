...
import io.bepis.apollox.loaders.AlbumLoader;
...
public class AlbumFragment extends Fragment implements LoaderCallbacks<List<Album>>,
    ...
    private boolean isSimpleLayout() {
        return PreferenceUtils.getInstance(getActivity()).isSimpleLayout(PreferenceUtils.ALBUM_LAYOUT,
                getActivity());
    }

    private boolean isDetailedLayout() {
        return PreferenceUtils.getInstance(getActivity()).isDetailedLayout(PreferenceUtils.ALBUM_LAYOUT,
                getActivity());
    }
}
