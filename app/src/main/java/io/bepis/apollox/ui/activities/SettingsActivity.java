...
import io.bepis.apollox.ui.fragments.ThemeFragment;
...
public class SettingsActivity extends PreferenceActivity {
    ...
    private void showversion() {
        final Preference mversion = findPreference("version");
        mversion.setOnPreferenceClickListener(new OnPreferenceClickListener() {

            @Override
            public boolean onPreferenceClick(final Preference preference) {
                ApolloUtils.createversionDialog(SettingsActivity.this).show();
                return true;
            }
        });
    }
