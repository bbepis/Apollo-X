...
import io.bepis.apollox.appwidgets.AppWidgetLarge;
import io.bepis.apollox.appwidgets.AppWidgetLargeAlternate;
import io.bepis.apollox.appwidgets.AppWidgetLargeAlternateTransparent;
import io.bepis.apollox.appwidgets.AppWidgetLargeTransparent;
import io.bepis.apollox.appwidgets.AppWidgetSmall;
import io.bepis.apollox.appwidgets.AppWidgetSmallTransparent;
import io.bepis.apollox.appwidgets.RecentWidgetProvider;
import io.bepis.apollox.cache.ImageCache;
import io.bepis.apollox.cache.ImageFetcher;
import io.bepis.apollox.provider.FavoritesStore;
import io.bepis.apollox.provider.RecentStore;
import io.bepis.apollox.utils.ApolloUtils;
import io.bepis.apollox.utils.Lists;
import io.bepis.apollox.utils.MusicUtils;
...
public class MusicPlaybackService extends Service {
    ...
    /**
     * 4x1 widget transparent
     */
    private final AppWidgetSmallTransparent mAppWidgetSmallTransparent = AppWidgetSmallTransparent.getInstance();

    /**
     * 4x2 widget transparent
     */
    private final AppWidgetLargeTransparent mAppWidgetLargeTransparent = AppWidgetLargeTransparent.getInstance();

    /**
     * 4x2 alternate widget transparent
     */
    private final AppWidgetLargeAlternateTransparent mAppWidgetLargeAlternateTransparent = AppWidgetLargeAlternateTransparent
            .getInstance();
...
//        }
    ...
    private void notifyChange(final String what) {
        ...
        mAppWidgetLargeAlternateTransparent.notifyChange(this, what);
        mAppWidgetLargeTransparent.notifyChange(this, what);
        mAppWidgetSmallTransparent.notifyChange(this, what);
