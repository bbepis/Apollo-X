...
package io.bepis.apollox.model;
...
public class Song {
     ...
     * @param songYear The year the song was recorded
     * @param trackNumber The song number in album (1XXX, where 1 is cd number, XXX is track number)
     */
    public Song(final long songId, final String songName, final String artistName,
            final String albumName, final int duration, final int songYear, final int trackNumber) {
        mSongId = songId;
        mSongName = songName;
        ...
        mDuration = duration;
        mYear = songYear;
        mTrackNumber = trackNumber % 1000;
        mCdNumber = (int) Math.floor(trackNumber / 1000);
    }
