...
/**
 * Avoid crash when attempting to load many items
 * Thread pool executor will reject additional tasks when it has exhausted it's queue space causing Apollo to crash.
