...
package io.bepis.apollox.cache;
...
import io.bepis.apollox.lastfm.Album;
import io.bepis.apollox.lastfm.Artist;
import io.bepis.apollox.lastfm.ImageSize;
import io.bepis.apollox.lastfm.MusicEntry;
...
public class ImageFetcher extends ImageWorker {
    ...
    private static String getBestImage(MusicEntry e) {
        final ImageSize[] QUALITY = {ImageSize.ORIGINAL, ImageSize.MEGA, ImageSize.EXTRALARGE, ImageSize.HUGE, ImageSize.LARGE, ImageSize.MEDIUM,
