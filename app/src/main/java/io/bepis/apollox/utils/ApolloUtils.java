...
package io.bepis.apollox.utils;
...
import io.bepis.apollox.ui.activities.ShortcutActivity;
import io.bepis.apollox.widgets.ColorPickerView;
import io.bepis.apollox.widgets.ColorSchemeDialog;
import io.bepis.apollox.widgets.TagEditorDialog;
import io.devspark.appmsg.AppMsg;
...
public final class ApolloUtils {
    ...
    /**
     * @param context The {@link Context} to use.
     * @return An {@link AlertDialog} used to show the changelog
     *         of Apollo.
     */
    public static final AlertDialog createversionDialog(final Context context) {
        final WebView webView = new WebView(context);
        webView.loadUrl("file:///android_asset/version.html");
        return new AlertDialog.Builder(context)
                .setTitle(R.string.settings_version_title)
                .setView(webView)
                .setPositiveButton(android.R.string.ok, null)
                .create();
    }
    ...
    /**
     * Shows the {@link TagEditorDialog}
     * 
     * @param context The {@link Context} to use.
     * @param mSong The {@link Song} to use.
     */
    public static void showTagsEditor(final Context context, final Song mSong) {
        final TagEditorDialog tagEditorView = new TagEditorDialog(context, mSong);
        tagEditorView.show();
    }
