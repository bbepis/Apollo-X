...
import io.bepis.apollox.IApolloService;
...
import io.bepis.apollox.loaders.PlaylistLoader;
...
import io.bepis.apollox.provider.FavoritesStore.FavoriteColumns;
...
public final class MusicUtils {
    ...
    public static final ServiceToken bindToService(final Context context,
        ...
        contextWrapper.startForegroundService(new Intent(contextWrapper, MusicPlaybackService.class));
