 ...
 */
@SuppressLint("NewApi")
public class AppWidgetSmallTransparent extends AppWidgetBase {

    public static final String CMDAPPWIDGETUPDATE = "app_widget_small_transparent_update";

    private static AppWidgetSmallTransparent mInstance;

    public static synchronized AppWidgetSmallTransparent getInstance() {
        if (mInstance == null) {
            mInstance = new AppWidgetSmallTransparent();
        }
        return mInstance;
    }
    ...
    public void onUpdate(final Context context, final AppWidgetManager appWidgetManager,
        ...
        updateIntent.putExtra(MusicPlaybackService.CMDNAME, AppWidgetSmallTransparent.CMDAPPWIDGETUPDATE);
    ...
    private void defaultAppWidget(final Context context, final int[] appWidgetIds) {
        final RemoteViews appWidgetViews = new RemoteViews(context.getPackageName(),
                R.layout.app_widget_small_transparent);
