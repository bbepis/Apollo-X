 ...
 */
@SuppressLint("NewApi")
public class AppWidgetLargeTransparent extends AppWidgetBase {

    public static final String CMDAPPWIDGETUPDATE = "app_widget_large_transparent_update";

    private static AppWidgetLargeTransparent mInstance;

    public static synchronized AppWidgetLargeTransparent getInstance() {
        if (mInstance == null) {
            mInstance = new AppWidgetLargeTransparent();
        }
        return mInstance;
    }
    ...
    public void onUpdate(final Context context, final AppWidgetManager appWidgetManager,
        ...
        updateIntent.putExtra(MusicPlaybackService.CMDNAME, AppWidgetLargeTransparent.CMDAPPWIDGETUPDATE);
    ...
    private void defaultAppWidget(final Context context, final int[] appWidgetIds) {
        final RemoteViews appWidgetViews = new RemoteViews(context.getPackageName(),
                R.layout.app_widget_large_transparent);
