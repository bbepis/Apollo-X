...
package io.bepis.apollox.appwidgets;
...
import io.bepis.apollox.MusicPlaybackService;
import io.bepis.apollox.R;
import io.bepis.apollox.ui.activities.AudioPlayerActivity;
import io.bepis.apollox.ui.activities.HomeActivity;
 ...
 */
@SuppressLint("NewApi")
public class AppWidgetLargeAlternateTransparent extends AppWidgetBase {

    public static final String CMDAPPWIDGETUPDATE = "app_widget_large_alternate_transparent_update";

    private static AppWidgetLargeAlternateTransparent mInstance;

    public static synchronized AppWidgetLargeAlternateTransparent getInstance() {
        if (mInstance == null) {
            mInstance = new AppWidgetLargeAlternateTransparent();
        }
        return mInstance;
    }
    ...
    public void onUpdate(final Context context, final AppWidgetManager appWidgetManager,
        ...
        updateIntent.putExtra(MusicPlaybackService.CMDNAME,
                AppWidgetLargeAlternateTransparent.CMDAPPWIDGETUPDATE);
    ...
    private void defaultAppWidget(final Context context, final int[] appWidgetIds) {
        final RemoteViews appWidgetViews = new RemoteViews(context.getPackageName(),
                R.layout.app_widget_large_alternate_transparent);
